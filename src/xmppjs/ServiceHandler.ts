...
export class ServiceHandler {
    ...
    constructor(private xmpp: XmppJsInstance, private bridgeConfig: IConfigBridge) {
        ...
        this.userDiscoInfo.feature.add(XMPPFeatures.JingleRTP);
        this.userDiscoInfo.feature.add(XMPPFeatures.JingleRTPAudio);
        this.userDiscoInfo.feature.add(XMPPFeatures.JingleRTPVideo);
